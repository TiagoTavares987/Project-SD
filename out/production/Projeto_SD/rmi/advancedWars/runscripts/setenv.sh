...
#@REM =====================================================================================================
# @REM ==== PC STUFF ====
export JDK=/Users/tavs/Library/Java/JavaVirtualMachines/liberica-1.8.0_332
...
export USERNAME=tavs

#@REM ==== JAVA NAMING STUFF ====
export JAVAPROJ_NAME=Projeto_SD
export JAVAPROJ=/Users/tavs/Developer/IdeaProject/Projeto_SD

export PACKAGE=advancedWars
export PACKAGE_PREFIX=rmi
export PACKAGE_PREFIX_FOLDERS=rmi
export SERVICE_NAME_ON_REGISTRY=advancedWarsService
export CLIENT_CLASS_PREFIX=advancedWars
export SERVER_CLASS_PREFIX=advancedWars
