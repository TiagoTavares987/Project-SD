 ...
 * @version 3.0
 */
public class advancedWarsServer {
     ...
     */
    private ProjectFactoryRI diglibfactoryRI;
    ...
    public static void main(String[] args) {
        if (args != null && args.length < 3) {
            ...
            //1. ============ Create Servant ============
            advancedWarsServer hws = new advancedWarsServer(args);
     ...
     * @param args 
     */
    public advancedWarsServer(String args[]) {
        try {
            //============ List and Set args ============
    ...
    private void rebindService() {
        try {
            ...
            if (registry != null) {
                //============ Create Servant ============
                diglibfactoryRI = (ProjectFactoryRI) new ProjectFactoryImpl();
