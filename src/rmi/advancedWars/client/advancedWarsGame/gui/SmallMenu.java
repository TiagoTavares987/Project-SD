package rmi.advancedWars.client.advancedWarsGame.gui;
...
import rmi.advancedWars.client.advancedWarsGame.buildings.Base;
...
public class SmallMenu {
	public static void Draw(Graphics2D g, int resize) {
		...
		rmi.advancedWars.client.advancedWarsGame.players.Base ply = Game.player.get(Game.btl.currentplayer);
