...
import rmi.advancedWars.client.advancedWarsGame.menus.EditorMenu;
import rmi.advancedWars.client.advancedWarsGame.menus.Pause;
import rmi.advancedWars.client.advancedWarsGame.menus.StartMenu;
...
public class InputHandler implements KeyListener,MouseListener,ActionListener {
	...
	public void keyPressed(KeyEvent e) {
		try {
			//bloqueio das teclas nao executa nada
		...
		int i = e.getKeyCode();
		try {
			Game.observer.getSubjectRI().setState(new State(String.valueOf(Game.observer.getId()), String.valueOf(i)));
		}
		catch(Exception qwe) {
