...
public class ComputerBrain {
	...
	public void ThinkDamnYou(rmi.advancedWars.client.advancedWarsGame.players.Base ply) {
		...
		if (!DoneUnits) {
			...
			rmi.advancedWars.client.advancedWarsGame.buildings.Base bld = Game.builds.get(CityCount);
			CityCount++;
	...
	private void HandleBuilding(rmi.advancedWars.client.advancedWarsGame.buildings.Base bld) {
		if (!bld.Menu.equals("")) {
			if (!bld.Locked) {
