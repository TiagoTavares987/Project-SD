...
public class MapParser {
	...
	private String CityID(rmi.advancedWars.client.advancedWarsGame.buildings.Base bld) {
		String a = "00";
	...
	private String UnitID(Base unit) {
		String a = "00";
	...
	private List<rmi.advancedWars.client.advancedWarsGame.buildings.Base> FormatCities(List<rmi.advancedWars.client.advancedWarsGame.buildings.Base> oldblds) {
		List<rmi.advancedWars.client.advancedWarsGame.buildings.Base> newblds = new ArrayList<rmi.advancedWars.client.advancedWarsGame.buildings.Base>();
