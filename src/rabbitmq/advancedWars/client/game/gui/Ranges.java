package rabbitmq.advancedWars.client.game.gui;
...
import rabbitmq.advancedWars.client.game.engine.Pathfinding;

/**
 * Depending on if a unit is selected by the current player and the edu.ufp.inf.sd.rmi._00_project.client.game.units state, it will draw the movement range (based on path finding outcome).
 ...
 * It will also draw the attackable locations depending on the edu.ufp.inf.sd.rmi._00_project.client.game.units max and min attack ranges.
 * @author SergeDavid
 * @version 0.3
 */
public class Ranges {
