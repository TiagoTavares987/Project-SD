 ...
 * Place MoveView(); in the game-loop (100ms) to automate it (Teleporting across the map between switching viewed edu.ufp.inf.sd.rmi._00_project.client.game.units / turns is automatic)
