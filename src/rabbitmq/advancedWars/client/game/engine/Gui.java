...
public class Gui extends JPanel {
	...
	public void LoginScreen() {
		...
		removeAll();
		new rabbitmq.advancedWars.client.game.menus.StartMenu();
	...
	public void paintComponent(Graphics g) {
		...
		case PLAYING:
			...
			rabbitmq.advancedWars.client.game.gui.Terrain.Draw(gg, Game.ScreenBase);
			rabbitmq.advancedWars.client.game.gui.Ranges.Draw(gg, Game.ScreenBase);
			rabbitmq.advancedWars.client.game.gui.Cities.Draw(gg, Game.ScreenBase);
			rabbitmq.advancedWars.client.game.gui.Units.Draw(gg, Game.ScreenBase);
			rabbitmq.advancedWars.client.game.gui.Selector.Draw(frame, gg, Game.ScreenBase,
					Game.player.get(Game.btl.currentplayer).selectx,
					Game.player.get(Game.btl.currentplayer).selecty);
			rabbitmq.advancedWars.client.game.gui.SmallMenu.Draw(gg,frame);
		break;
		case EDITOR:
			gg.setColor(new Color(0,0,60));
			gg.fillRect(0, 0, width, height);
