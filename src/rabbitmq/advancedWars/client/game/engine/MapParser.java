...
public class MapParser {
	...
	private String encodeInfo() {//TODO: Total edu.ufp.inf.sd.rmi._00_project.client.game.players. (start with 2, and add more depending on unit and building owners.)
	...
	private String encodeDesc() {
		//TODO: Replace name with current edu.ufp.inf.sd.rmi._00_project.client.game.players name, and leave description for manliness?
	...
	private String CityID(rabbitmq.advancedWars.client.game.buildings.Base bld) {
		String a = "00";
	...
	private String UnitID(rabbitmq.advancedWars.client.game.units.Base unit) {
		String a = "00";
	...
	private List<rabbitmq.advancedWars.client.game.buildings.Base> FormatCities(List<rabbitmq.advancedWars.client.game.buildings.Base> oldblds) {
		List<rabbitmq.advancedWars.client.game.buildings.Base> newblds = new ArrayList<rabbitmq.advancedWars.client.game.buildings.Base>();
	 ...
	 * xx = Map Width
	 * yy = Map Height
	 * x = Total edu.ufp.inf.sd.rmi._00_project.client.game.players*/
	...
	/**This is for decoding the edu.ufp.inf.sd.rmi._00_project.client.game.terrain, it currently goes with 1 line = 1 row
	 * 2 = Byte
	 ...
	 * f = Owner (0-11 are edu.ufp.inf.sd.rmi._00_project.client.game.players, 15 is neutral, 12-14 are unused)
	 * ff = type
	 * x location (x)
	 * y location (y)*/
