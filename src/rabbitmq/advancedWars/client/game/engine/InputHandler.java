 ...
 * Menus are being moved to edu.ufp.inf.sd.rmi._00_project.client.game.gui.gms
 * @author SergeDavid
 * @version 0.1
 */
...
public class InputHandler implements KeyListener,MouseListener,ActionListener {
	...
	public void keyPressed(KeyEvent e) {
		...
		if (Game.GameState==Game.State.PLAYING) {
			rabbitmq.advancedWars.client.game.players.Base ply = Game.player.get(Game.btl.currentplayer);
			...
			else if (i==start) {new rabbitmq.advancedWars.client.game.menus.Pause();}
		...
		if (Game.GameState==Game.State.EDITOR) {
			if (i==up) {Game.edit.selecty--;if (Game.edit.selecty<0) {Game.edit.selecty++;} Game.edit.moved = true;}
				...
				new rabbitmq.advancedWars.client.game.menus.EditorMenu();
			}
		}
		...
		else if (i==dev6) {new rabbitmq.advancedWars.client.game.menus.StartMenu();}
	}
