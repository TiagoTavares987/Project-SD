...
public class Editor {
	...
	public void AssButton() {
		...
		case CITY:
			AddBuilding();
			Game.map.map[selecty][selectx] = new rabbitmq.advancedWars.client.game.terrain.City();
		break;
		case UNIT:
	...
	public void ButtButton() {
		new rabbitmq.advancedWars.client.game.menus.EditorStuff();
	}
	
	private void AddBuilding() {
		moved = false;//Keeps game from generating lots of useless edu.ufp.inf.sd.rmi._00_project.client.game.buildings.
