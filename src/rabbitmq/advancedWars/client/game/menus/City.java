...
/**
 * Displays a list of available edu.ufp.inf.sd.rmi._00_project.client.game.units, and some information about them to buy.
 * @author SergeDavid
 * @version 0.2
 */
public class City implements ActionListener,ListSelectionListener {
	...
	private void ChangeAlt() {
		Alt.removeAll();
		rabbitmq.advancedWars.client.game.units.Base unit = Game.displayU.get(current);
